...
function validateMakeObject(email, first_name, last_name, phone, age, address) {
  ...
  alert(
    "First Name: " +
      JSONObject.shopper[0].firstName +
      "\nLast Name: " +
      JSONObject.shopper[0].lastName +
      "\nEmail: " +
      JSONObject.shopper[0].email +
      "\nPhone: " +
      JSONObject.shopper[0].phone +
      "\nAge: " +
      JSONObject.shopper[0].age +
      "\nAddress: " +
      JSONObject.shopper[0].address
  );
}
